...
4. [HTTP Uprobe Runtime](ebpf/http-uprobes.md): connect-driven attach, event delivery, reconciliation, selected functions, and known coverage gaps.
...
7. [Manager Architecture](manager.md): config, rules, and log delivery outside the Agent runtime path.

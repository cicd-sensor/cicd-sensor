...
struct http_scratch {
    ...
    // nghttp2 pointers and lengths carried across the two semantic tail targets:
    // required fields, then optional authority plus emit. Raw bytes stay in userspace.

...
// proxyHandlerGitHub stages the daemon's cgroup basename using peer-PID identity.
func proxyHandlerGitHub(logger *slog.Logger, upstreamSocket, agentSocket, driver string) http.Handler {

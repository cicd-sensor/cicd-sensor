...
var kernelSampleABISize = map[string]uintptr{
	...
	"HttpUprobeAttachCandidateSample": 72,
	"MountSample":                     2096,
	"NetV4Sample":                     48,
	"NetV6Sample":                     64,
...
func TestKernelSampleABISizes(t *testing.T) {
	cases := map[string]reflect.Type{
		...
		"HttpUprobeAttachCandidateSample": reflect.TypeOf(bpfprog.BPFProgramHttpUprobeAttachCandidateSample{}),
...
func TestKernelSampleABIKindField(t *testing.T) {
	types := []reflect.Type{
		...
		reflect.TypeOf(bpfprog.BPFProgramHttpUprobeAttachCandidateSample{}),
...
func TestKernelSampleKindValues(t *testing.T) {
	cases := map[uint32]uint32{
		...
		kernelio.SampleKindHTTPUprobeAttachCandidate: 16,
	}
